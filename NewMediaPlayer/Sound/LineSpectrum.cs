...
namespace NewMediaPlayer.Sound
{
    public class LineSpectrum : SpectrumBase
    {
        ...
        public static event GetFFTData gfftd;
        ...
        public Bitmap CreateSpectrumLine(System.Drawing.Size size, System.Drawing.Brush brush, System.Drawing.Color background, bool highQuality)
        {
            ...
            {
                gfftd?.Invoke(fftBuffer);
                using (var pen = new System.Drawing.Pen(brush, (float)_barWidth))
                {
