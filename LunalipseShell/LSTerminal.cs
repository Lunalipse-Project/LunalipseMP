...
namespace LunalipseShell
{
    public class LSTerminal:TextBox
    {
        ...
        public Dictionary<string, string> Help_Descriptor { get; private set; }
        ...
        public LSTerminal()
        {
            ...
            Help_Descriptor = new Dictionary<string, string>();
            ...
            switch (direction)
            {
                ...
                case CommandHistoryDirection.FORWARD:
                    if (indexInLog < CommandLog.Count - 1)
                        indexInLog++;
                    if (CommandLog.Count > 0 && indexInLog< CommandLog.Count)
                    {
                        Text = GetTextWithPromptSuffix(CommandLog[indexInLog].Raw);
                        CaretIndex = Text.Length;
                    }
